...
LLM_MODEL = os.getenv("RAG_LLM_MODEL", "gemini-2.5-flash")  # or gemini-2.5-pro
TEMPERATURE = float(os.getenv("RAG_TEMP", "0.8"))

# Example for questions
QUESTION = os.getenv("RAG_QUESTION", "what is Big Data?")
# QUESTION = os.getenv("RAG_QUESTION", "who is the prime minister of Israel?")
